...
export function SettingsDialog({ open: openProp, onOpenChange }: SettingsDialogProps) {
  ...
  const [solutionModel, setSolutionModel] = useState('gemini-1.5-pro')
  const [debuggingModel, setDebuggingModel] = useState('gemini-1.5-pro')
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-white/50">
              ...
              {apiProvider === 'gemini' ? 'Google' : 'OpenAI'}
            </p>
          ...
          <div className="space-y-4 mt-4">
            <label className="text-sm font-medium text-white mb-2">AI Model Selection</label>
